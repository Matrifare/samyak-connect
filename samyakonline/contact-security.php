...
$sql = "select contact_view_security from register_view where matri_id='" . $matri_id . "'";
...
if (mysqli_num_rows($DatabaseCo->dbResult) > 0) {
            ...
            <div class="container mb-80">
                <div class="content-wrapper mb-70">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pt-20">
                                <form method="post" id="change_contact_security_form">
                                    <h6 id="response_contact_security"
                                        class="text-center text-danger"></h6>
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            <p class="pt-15 pb-10" style="font-size: 16px;"><i
                                                        class="fa fa-phone-square"></i> Who can see your contact details
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        <div class="col-sm-offset-4 col-sm-4 col-xs-12 text-left">
                                            <label class="checkbox-inline check" style="margin: 4px 0 3px;">
                                                <input name="contact_security" type="checkbox" value="Visible"
                                                       style="display: block;opacity: 1;margin-left: 0px;position: relative;"
                                                <?= (!empty($Row->contact_view_security) && $Row->contact_view_security == '1') ? "checked" : "" ?>
                                                >
                                    ...
                                    <div class="row">
                                        <div class="col-sm-offset-4 col-sm-4 col-xs-12 text-left">
                                            <label class="checkbox-inline check" style="margin: 4px 0 3px;">
                                                <input name="contact_security" type="checkbox" value="VisibleToSome"
                                                       style="display: block;opacity: 1;margin-left: 0px;position: relative;"
                                                    <?= ($Row->contact_view_security == '0') ? "checked" : "" ?>
                                                >
                                                Show to only sent or accepted express interests.
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-offset-4 col-sm-4 col-xs-12 text-left">
                                            <label class="checkbox-inline check" style="margin: 4px 0 3px;">
                                                <input name="contact_security" type="checkbox" value="NotVisible"
                                                       style="display: block;opacity: 1;margin-left: 0px;position: relative;"
                                                    <?= (!empty($Row->contact_view_security) && $Row->contact_view_security == '2') ? "checked" : "" ?>
                                                >
                                                Don't show my contact details
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            <button type="submit"
                                                    ...
                                                    name="change_contact_details">Update Contact Security
                                            </button>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        $(function () {
            ...
            $("#change_contact_security_form").submit(function (e) {
                $("#response_contact_security").html("");
                $.ajax({
                    type: "POST", // HTTP method POST or GET
                    url: "web-services/change_contact_security", //Where to make Ajax calls
                    dataType: 'json',
                    beforeSend: function () {
                        $("#loader-animation-area").show();
                    },
                    data: $(this).serialize() + "&change_contact_security=true",
                    success: function (response) {
                        $("#response_contact_security").html(response.msg);
                    },
                    complete: function () {
