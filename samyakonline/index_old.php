...
<div style="overflow-x: hidden !important;">
    ...
    <div class="container-wrapper colored-navbar-brand">
        ...
        <div class="main-wrapper">
            <div class="homepage-new-header">
                <div class="logo-image-new-homepage">
                    <a class="" href="index">
                        <img src="logo/buddhist-matrimony.png" alt="Buddhist Matrimony" title="Buddhist Matrimony">
                    </a>
                </div>
                <div class="new-menu-homepage float-right">
                    <div class="mobile-menu-list">
                        <div class="mobile-menu-list-item">
                            <a class="mobile-link-homepage menu_btn_homepage" href="javascript:void(0);" onClick="openHomePageRightSideMenu();"><i class="fa fa-bars"></i> </a>
                        </div>
                    </div>
                </div>
            </div>
            <!-- start hero-header -->
            <div class="hero1-homepage"
                 style="background-image:url('img/buddhist-matrimonials1.jpg');">
                <div class="container">
