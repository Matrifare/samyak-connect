                    ...
                    <div class="navbar-mini">
                        <ul class="clearfix">
                            <li class="user-action">
                                <a href="javascript:void(0);" style="margin-top: 14px;color: #FFF; padding: 5px; float: right;text-align: right;" onclick="window.location.href='login'" class="btn btn-primary"> &nbsp; &nbsp; Login &nbsp; &nbsp; </a>
                            </li>
                        </ul>
                    </div>
