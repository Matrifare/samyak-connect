 ...
 * Time: 7:43 PM
 */
class Config extends DatabaseConnection
{
    private $_configId;
    private $_configName;
    ...
    private $_configFacebookLink;
    private $_configGoogleLink;
    private $_configTwitterLink;
    private $_configLinkedinLink;
        ...
        if (!empty($configId) && is_numeric($configId)) {
            ...
            */
            ...
            while ($dbRow = mysqli_fetch_object($dbResult)) {
                ...
                $this->_configFacebookLink = $dbRow->facebook;
                $this->_configGoogleLink = $dbRow->google;
                $this->_configTwitterLink = $dbRow->twitter;
                $this->_configLinkedinLink = $dbRow->linkedin;
            }
        } else {
            $this->_configId = "";
            $this->_configName = "";
            ...
            $this->_configLine2 = "";
            $this->_configLine3 = "";
            $this->_configFacebookLink = "";
            $this->_configGoogleLink = "";
            $this->_configTwitterLink = "";
            $this->_configLinkedinLink = "";
    ...
    public function getAllConfig()
    {
        ...
        while ($dbRow = mysqli_fetch_object($dbResult)) {
            ...
            $config->setConfigFacebookLink($dbRow->facebook);
            $config->setConfigTwitterLink($dbRow->twitter);
            $config->setConfigLinkedinLink($dbRow->linkedin);
            $config->setConfigGoogleLink($dbRow->google);
    ...
    public function setConfigFacebookLink($configFacebookLink)
    {
        $this->_configFacebookLink = $configFacebookLink;
    }

    public function setConfigTwitterLink($configTwitterLink)
    {
        $this->_configTwitterLink = $configTwitterLink;
    }

    public function setConfigLinkedinLink($configLinkedinLink)
    {
        $this->_configLinkedinLink = $configLinkedinLink;
    }

    public function setConfigGoogleLink($configGoogleLink)
    {
        $this->_configGoogleLink = $configGoogleLink;
    }
    ...
    public function getConfigFacebookLink()
    {
        return $this->_configFacebookLink;
    }

    public function getConfigTwitterLink()
    {
        return $this->_configTwitterLink;
    }

    public function getConfigLinkedinLink()
    {
        return $this->_configLinkedinLink;
    }

    public function getConfigGoogleLink()
    {
        return $this->_configGoogleLink;
    }
}