...
<div class="row mb-10">
    <div class="col-xs-12">
        <p>
            <strong>Note:-</strong> Photo not larger than 5 MB.
        </p>
    </div>
</div>
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a title="" href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo1)."&watermark=watermark.png";
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo2)."&watermark=watermark.png";
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo3)."&watermark=watermark.png";
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo4)."&watermark=watermark.png";
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo5)."&watermark=watermark.png";
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo6)."&watermark=watermark.png";
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo7)."&watermark=watermark.png";
    ...
    <div class="col-sm-3 col-xs-6 mb-10 pr-4">
        <a href="javascript:void(0);" class="destination-grid-sm-item"
           onclick="">
            <div class="image">
                <?php
                $isPhotoAvailable = "photos/watermark?image=" . trim($Row->photo8)."&watermark=watermark.png";
