...
$photo7 = $DatabaseCo->dbRow->photo7;
$photo8 = $DatabaseCo->dbRow->photo8;
...
$eating = $DatabaseCo->dbRow->diet;
$drinking = $DatabaseCo->dbRow->drink;
$smoking = $DatabaseCo->dbRow->smoke;
...
$desg = $DatabaseCo->dbRow->designation;
...
$video_url = $DatabaseCo->dbRow->video_url;
...
$part_complexation = $DatabaseCo->dbRow->part_complexion;
...
// Photo 1 as 5%  value + other 5% total 10%
if ($photo1 != '') {
    $photo1 = '5';
} else {
    $photo1 = '0';
}
if ($photo2 != '' && $photo3 != '' && $photo4 != '' && $photo5 != '' && $photo6 != '' && $photo7 != '' && $photo8 != '') {
    $photo2 = '5';
} else {
    $photo2 = '0';
}

// Basic Details as 11% value
if ($fname != '' && $lname != '') {
    $fname = '1';
} else {
    $fname = '0';
...
if ($part_height != '' && $part_height_to != '') {
    $part_height = '1';
} else {
    $part_height = '0';
}
if ($part_complexation != '') {
    $part_complexation = '1';
} else {
    $part_complexation = '0';
}
...
if ($part_country_living != '') {
    $part_country_living = '2';
} else {
    $part_country_living = '0';
}
if ($part_resi_status != '') {
    $part_resi_status = '1';
} else {
...
if ($father_occupation != '') {
    $father_occupation = '0.5';
} else {
    $father_occupation = '0';
}
if ($mother_occupation != '') {
    $mother_occupation = '0.5';
} else {
    $mother_occupation = '0';
}
if ($no_of_sisters != '') {
...
if ($no_marri_brothers != '') {
    $no_marri_brothers = '0.5';
} else {
    $no_marri_brothers = '0';
}
if ($no_marri_sisters != '') {
    $no_marri_sisters = '0.5';
} else {
    $no_marri_sisters = '0';
}
...
$hasCompletedBasic = ($fname + $lname + $mstatus + $mtongue + $bdate + $btime + $bplace + $profileby + $reference + $hobby + $profile_text + $eating + $smoking + $drinking);
$hasCompletedEdu = ($emp + $occ + $income + $edu + $desg);
...
$hasCompletedFamily = ($family_details + $father_name + $mother_name + $father_occupation + $mother_occupation + $no_of_sisters + $family_type + $family_status + $no_of_brothers + $no_marri_brothers + $no_marri_sisters);
