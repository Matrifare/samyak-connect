...
$sql = "select photo_view_status from register_view where matri_id='" . $matri_id . "'";
...
if (mysqli_num_rows($DatabaseCo->dbResult) > 0) {
            ...
            <div class="container mb-80">
                <div class="content-wrapper mb-70">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pt-20">
                                <form method="post" id="change_photo_security_form">
                                    <h6 id="response_photo_security"
                                        class="text-center text-danger"></h6>
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            <p class="pt-15 pb-10" style="font-size: 16px;"><i
                                                        class="fa fa-phone-square"></i> Who can see your photo
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row mt-30">
                                        <div class="col-sm-offset-4 col-sm-4 col-xs-12 text-left">
                                            <label class="checkbox-inline check" style="margin: 4px 0 3px;">
                                                <input name="photo_security" type="checkbox" value="Visible"
                                                       style="display: block;opacity: 1;margin-left: 0px;position: relative;"
                                                <?= (!empty($Row->photo_view_status) && $Row->photo_view_status == '1') ? "checked" : "" ?>
                                                >
                                                Visible to All
                                            </label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-offset-4 col-sm-4 col-xs-12 text-left">
                                            <label class="checkbox-inline check" style="margin: 4px 0 3px;">
                                                <input name="photo_security" type="checkbox" value="NotVisible"
                                                       style="display: block;opacity: 1;margin-left: 0px;position: relative;"
                                                    <?= ($Row->photo_view_status == '0') ? "checked" : "" ?>
                                                >
                                                Hide for All
                                            </label>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-offset-4 col-sm-4 col-xs-12 text-left">
                                            <label class="checkbox-inline check" style="margin: 4px 0 3px;">
                                                <input name="photo_security" type="checkbox" value="OnlyPaidMember"
                                                       style="display: block;opacity: 1;margin-left: 0px;position: relative;"
                                                    <?= ($Row->photo_view_status == '2') ? "checked" : "" ?>
                                                >
    ...
    <script>
        $(function () {
            ...
            $("#change_photo_security_form").submit(function (e) {
                $("#response_photo_security").html("");
                $.ajax({
                    type: "POST", // HTTP method POST or GET
                    url: "web-services/change_photo_security", //Where to make Ajax calls
                    dataType: 'json',
                    beforeSend: function () {
                        $("#loader-animation-area").show();
                    },
                    data: $(this).serialize() + "&change_photo_security=true",
                    success: function (response) {
                        $("#response_photo_security").html(response.msg);
                    },
                    complete: function () {
