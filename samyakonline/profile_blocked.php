    ...
    <div class="modal-dialog modal-md" style="border: 2px solid red; background-color: #fff;">
        <div class="modal-content" style="box-shadow: none !important;">
            ...
            <div class="modal-body pb-10 text-center" id="">
                    <h5 class="section-header-3 text-danger">Your Profile is Blocked for suspicious activity.</h5>
            </div>
        </div>
        <div class="modal-footer">
            <div class="row">
                <div class="col-xs-12 text-center">
                    ...
                    <a href="<?= "https://api.whatsapp.com/send?phone=917977993616&text=Hello,%0APlease activate my account. It is blocked for suspicious activity." ?>"
                       title="Whatsapp"><i class="fa fa-whatsapp"></i>
                        Click to chat for unblocking account</a>
                </div>
            </div>
        </div>
    </div>
