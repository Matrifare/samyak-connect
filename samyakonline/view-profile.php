...
$approve = sanitize($approve);
$reverseProfile = hexdec($profile);
$reverseApprove = hexdec($approve);
$key = 726925;
$reverseProfile = $reverseProfile / $key;
$reverseApprove = $reverseApprove / $key;

//Approver Data
$sqlApprove = "select matri_id from register_view WHERE index_id=" . $reverseApprove;
$fetch = mysqli_fetch_array($DatabaseCo->getSelectQueryResult($sqlApprove));
$matriIdApprove = $fetch['matri_id'] ?? "";
...
if (!empty($matriId)) {
    $SQL_STATEMENT = "SELECT r.*, p.p_plan,
                ...
                WHERE r.matri_id = '" . $matriId . "'  AND r.status NOT IN ('Inactive', 'Suspended')";
                                        ...
                                        <div class="panel-body  pa-0">
                                            <div class="profile-box">
                                                ...
                                                <div class="profile-info text-center mb-5">
                                                    ...
                                                    <div class="profile-img-wrap">
                                                        <a href="login" title="Login to View Photo">
                                                            ...
                                                            if (isset($_SESSION['email']) &&
                                                                ...
                                                                if (!empty(trim($Row->photo1)) && file_exists('photos/' . trim($Row->photo1)) &&
                                                                    !empty(trim($Row->photo_protect)) && $Row->photo_protect == 'No') {
                                                                    $showPhoto = "watermark?image=photos_big/" . trim($Row->photo1) . "&watermark=photos_big/watermark.png";
                                                                } else {
                                                                    if ($Row->gender == 'Groom') {
                                                    ...
                                                    <?php
                                                    if (!empty($matriIdApprove)) {
                                                        $sqlInterest = "select ei_id from expressinterest where ei_sender='" . $Row->matri_id . "' and ei_receiver='" . $matriIdApprove . "' and receiver_response='Pending' LIMIT 1";
                                                        $dataInterest = $DatabaseCo->dbLink->query($sqlInterest);
                                                        while ($RowInterest = mysqli_fetch_object($dataInterest)) {
                                                            ?>
                                                            <div class="row mt-10">
                                                                <div class="col-xs-12">
                                                                    <button id="accept<?= $RowInterest->ei_id ?>"
                                                                            href="javascript:void(0);"
                                                                            onclick="acceptint('<?= $RowInterest->ei_id ?>')"
                                                                            class="btn btn-success btn-xs"
                                                                            style="background: #005294; border-color: #005294; padding:4px 18px;"
                                                                            title="Accept Interest">Accept
                                                                    </button>
                                                                    <button id="reject<?= $RowInterest->ei_id ?>"
                                                                            href="javascript:void(0);"
                                                                            onclick="rejectint('<?= $RowInterest->ei_id ?>')"
                                                                            class="btn btn-danger btn-xs"
                                                                            style="background: #D60D45; border-color: #D60D45; padding:4px 18px;"
                                                                            title="Reject Interest">Reject
                                                                    </button>
                                                                    <button id="hold<?= $RowInterest->ei_id ?>"
                                                                            href="javascript:void(0);"
                                                                            onclick="onHoldInt('<?= $RowInterest->ei_id ?>')"
                                                                            class="btn btn-warning btn-xs"
                                                                            style="background-color: blueviolet; border-color: blueviolet; padding:4px 18px;"
                                                                            title="Decide Later this Interest">Not Now
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-10">
                                                                <div class="col-xs-12">
                                                                    <div class="text-success acceptedInterest"></div>
                                                                    <div class="text-danger rejectedInterest"></div>
                                                                    <div class="text-info holdInterest"></div>
                                                                </div>
                                                            </div>
                                                            <?php
                                                        }
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="pt-20">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    if ($Row->gender != 'Bride' && !empty($Row->drink)) {
                                                                        ?>
                                                                    ...
                                                                    if ($Row->gender != 'Bride' && !empty($Row->smoke)) {
                                                                        ?>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <?php }
                                                                    if (!empty($Row->income) && $Row->income != 'Not Available') {
                                                                        ?>
                                                                ...
                                                                <div class="row">
                                                                    <?php
                                                                    if (!empty($Row->family_type) && $Row->family_type != 'Not Available') {
                                                                        ?>
                                                                    ...
                                                                    if (!empty(!empty($Row->family_status)) && $Row->family_status != 'Not Available') {
                                                                        ?>
                                                            ...
                                                            if(!($Row->part_frm_age <= '19' || $Row->part_height == '48')) {
                                                                ...
                                                                <div class="pt-20 pb-10 hidden-sm hidden-md hidden-lg">
                                                                    ...
                                                                    <div class="row">
                                                                        <?php
                                                                        $part_education_level = mysqli_fetch_array($DatabaseCo->dbLink->query("SELECT GROUP_CONCAT(DISTINCT '', e_level_name, ''SEPARATOR ', ' ) AS part_edu_level FROM register a INNER JOIN education_level b ON FIND_IN_SET(b.e_level_id, a.part_edu_level) > 0 where a.matri_id = '$mid'  GROUP BY a.part_edu_level"));
                                                                        if (!empty($part_education_level['part_edu_level'])) {
                                                                            ?>
                                                                            <div class="col-xs-5 col-md-3 mb-7">
                                                                                Education
                                                                                Level:
                                                                            ...
                                                                            <div class="col-xs-7 col-md-3 mb-7"><?php
                                                                                echo !empty($part_education_level['part_edu_level']) ? $part_education_level['part_edu_level'] : "-"; ?></div>
                                                                            <?php
                                                                        }
                                                                        $part_education_field = mysqli_fetch_array($DatabaseCo->dbLink->query("SELECT GROUP_CONCAT(DISTINCT '', e_field_name, ''SEPARATOR ', ' ) AS part_edu_field FROM register a INNER JOIN education_field b ON FIND_IN_SET(b.e_field_id, a.part_edu_field) > 0 where a.matri_id = '$mid'  GROUP BY a.part_edu_field"));
                                                                        if (!empty($part_education_field['part_edu_field'])) {
                                                                            ?>
                                                                            <div class="col-xs-5 col-md-3 mb-7">
                                                                                Education
                                                                                Field:
                                                                            ...
                                                                            <div class="col-xs-7 col-md-3 mb-7">
                                                                                <?php
                                                                                echo !empty($part_education_field['part_edu_field']) ? $part_education_field['part_edu_field'] : "-"; ?>
                                                                            </div>
                                                                            <?php
                                                                        }
            ...
            function acceptint(expid) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $(".acceptedInterest").html("Interest Accepted Successfully");
                        setTimeout(function () {
                            $(".acceptedInterest").html("");
                        }, 5000);
                    },
                    complete: function () {
                    }
            ...
            function rejectint(expid) {
                $.ajax({
                    ...
                    success: function (response) {
                        $('#accept' + expid + '').fadeOut('slow');
                        $('#reject' + expid + '').fadeOut('slow');
                        $(".rejectedInterest").html("Interest Rejected Successfully");
                        setTimeout(function () {
                            $(".rejectedInterest").html("");
                        }, 5000);
                    },
                    complete: function () {
                    }
            ...
            function onHoldInt(expid) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $(".holdInterest").html("Interest converted to on hold Successfully");
                        setTimeout(function () {
                            $(".holdInterest").html("");
                        }, 5000);
                    },
