...
if (empty($each)) {
    echo '<select name="caste_id[]" id="caste_id" data-placeholder="Select Caste" class="form-control mb-5 chosen-select" multiple></select>';
    exit;
}
?>
<select name="caste_id[]" id="caste_id" data-placeholder="Select Caste" class="form-control mb-5 chosen-select" multiple>
